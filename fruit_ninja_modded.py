...
#? Fix file not found issue by creating relative directories.
img_folder = 'images\\' #! Folder you want to store your images... for the relative path.
...
while game_running :
    if game_over :
        ...
        game_over = False
        player_lives = 3
        draw_lives(gameDisplay, 690, 5, player_lives, dirname+'images/red_lives.png')
        score = 0
        ...
        if value['throw']:
            ...
            if not value['hit'] and current_position[0] > value['x'] and current_position[0] < value['x']+60 \
                ...
                if key == 'bomb':
                    ...
                    half_fruit_path = dirname+"images/explosion.png"
                else:
